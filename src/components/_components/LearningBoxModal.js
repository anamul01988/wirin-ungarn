...
export default function LearningBoxModal({ open, onClose, sourceUrl, title }) {
  ...
  return (
    <Dialog
      ...
      className="common_diallog__area dialog-learning-box-modal bg-white outline-none relative border-4 border-[#406c4d] rounded-2xl max-h-[90vh] overflow-hidden z-[10000]"
