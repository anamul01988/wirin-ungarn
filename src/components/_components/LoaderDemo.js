...
import Loader, { InlineLoader, FullscreenLoader, OverlayLoader } from "./Loader";
  ...
  return (
    <div className="p-8 space-y-12">
      ...
      <section className="border rounded-lg p-6">
        ...
        <p className="text-gray-600 mb-4">Centered in container with minimum height</p>
      ...
      <section className="border rounded-lg p-6">
        ...
        <p className="text-gray-600 mb-4">For inline use (doesn't take full width)</p>
        
        <div className="space-y-4">
          <div className="border rounded p-4">
            <h3 className="text-lg font-medium mb-2">Small Inline</h3>
            <div>
              Processing your request <InlineLoader size="small" text="Please wait..." />
            </div>
          </div>
      ...
      <section className="border rounded-lg p-6">
        <h2 className="text-2xl font-semibold mb-4">Fullscreen & Overlay Loaders</h2>
        <p className="text-gray-600 mb-4">Click buttons to see demos (they will cover the screen)</p>
...
<OverlayLoader size="medium" text="Processing..." />`}
          ...
          <div>
            <h3 className="font-medium mb-2">Backward Compatible (Old code still works):</h3>
            <pre className="bg-gray-800 text-white p-4 rounded overflow-x-auto">
