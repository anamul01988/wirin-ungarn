...
export default function LiedtexteComponent() {
  ...
  return (
    <>
      <Dialog
        ...
        className="common_diallog__area dialog-liedtexte bg-white outline-none relative border-4 border-[#406c4d] rounded-2xl h-[96vh] flex flex-col"
      >
