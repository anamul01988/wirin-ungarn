...
import UngarnInsiderPage from "@/components/pages/ungarnInsider/UngarnInsiderPage";
import ModalIcons from "@/components/_components/ModalIcons";
import Breadcrumb from "@/components/_components/Breadcrumb";

export default function InsiderComponent() {
  ...
  return (
    <>
      <Dialog
        ...
        className="common_diallog__area dialog-ungarn-insider bg-white relative border-4 border-[#406c4d] rounded-2xl h-[96vh] flex flex-col"
      >
