...
export default function EinfachComponent() {
  ...
  return (
    <>
      <Dialog
        ...
        className="common_diallog__area dialog-einfach-lesen bg-white outline-none relative border-4 border-[#406c4d] rounded-2xl h-[96vh] flex flex-col"
      >
