...
export default function KulinarischeComponent() {
  ...
  return (
    <>
      <Dialog
        ...
        className="common_diallog__area dialog-kulinarische-seele bg-white relative border-4 border-[#406c4d] rounded-2xl h-[96vh] flex flex-col"
      >
        ...
        <DialogBody className="overflow-auto mr-1 custom__modal_area_special flex-1">
          {/* Breadcrumb */}
