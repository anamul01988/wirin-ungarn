...
export default function KreuzwortraetselComponent() {
  ...
  return (
    <>
      <Dialog
        ...
        className="common_diallog__area dialog-kreuzwortraetsel bg-white outline-none relative border-4 border-[#406c4d] rounded-2xl h-[96vh] flex flex-col"
      >
